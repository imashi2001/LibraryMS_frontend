                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <select
                        id="role"
                        name="role"
                        className="appearance-none block w-full px-4 py-3 bg-white/90 border border-gray-300/80 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition shadow-sm backdrop-blur-sm"
                        value={role}
